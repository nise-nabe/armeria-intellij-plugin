...
internal class ArmeriaRouteLineMarkerProvider : LineMarkerProvider {
    override fun getLineMarkerInfo(element: PsiElement): LineMarkerInfo<*>? {
        return annotatedJavaMarker(element) ?: annotatedKotlinMarker(element) ?: serviceRegistrationMarker(element)
    }
    ...
    private fun serviceRegistrationMarker(element: PsiElement): LineMarkerInfo<*>? {
    ...
    companion object {
        private val SERVICE_REGISTRATION_METHODS = setOf("service", "serviceUnder", "annotatedService")
    }
}
