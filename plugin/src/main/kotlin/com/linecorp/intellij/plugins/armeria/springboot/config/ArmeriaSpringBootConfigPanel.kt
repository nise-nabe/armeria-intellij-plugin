...
class ArmeriaSpringBootConfigPanel(
    ...
    init {
        toolbar =
            ActionManager
                .getInstance()
                .createActionToolbar(
                    "ArmeriaSpringBootConfig",
                    DefaultActionGroup(
                        object : DumbAwareAction(message("springboot.config.action.refresh")) {
    ...
    private class ConfigTableModel : AbstractTableModel() {
        ...
        override fun getValueAt(
            ...
            0 -> rows[r].entry.key
            1 -> rows[r].entry.value
            else -> rows[r].fileName
        }
