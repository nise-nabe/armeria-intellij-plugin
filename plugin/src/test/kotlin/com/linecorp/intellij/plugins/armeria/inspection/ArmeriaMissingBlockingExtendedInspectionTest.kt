...
class ArmeriaMissingBlockingExtendedInspectionTest : ArmeriaFixtureTestBase5() {
    ...
    @Test
    fun stillHighlightsGraphqlDataFetcherJoinWithBlockingAnnotation() {
    ...
    @Test
    fun ignoresUnregisteredDataFetcherInFileWithGraphqlBuilder() {
        myFixture.configureByText(
            "UserFetcher.java",
            """
            package example;
            ...
            public class Server {
                public Object graphql() {
                    return GraphqlService.builder()
                            .runtimeWiring(c -> new TypeRuntimeWiring().dataFetcher("user", env -> "ok"))
                            .build();
                }
            }

            class UnusedFetcher implements DataFetcher<String> {
                public String get(Object env) {
                    return CompletableFuture.completedFuture("ok").join();
                }
            }
    ...
    @Test
    fun stillHighlightsHttpServiceServeWithBlocking() {
        myFixture.configureByText(
            "MyService.java",
            """
            package example;
    ...
    @Test
    fun highlightsExtractedDataFetcherLambdaViaMethodReference() {
        myFixture.configureByText(
            "Server.java",
            """
            package example;
    ...
    @Test
    fun allowsExtractedDataFetcherLambdaWithBlockingExecutor() {
        myFixture.configureByText(
            "Server.java",
            """
            package example;
    ...
    @Test
    fun doesNotAttributeFetcherBuiltInNonWiringArgument() {
        myFixture.configureByText(
            "Server.java",
            """
            package example;
            ...
            public class Server {
                ...
                private String helper() {
                    return new UserFetcher().toString();
                }
            }
    ...
    @Test
    fun doesNotHangOnCyclicWiringHelpers() {
        myFixture.configureByText(
            "Server.java",
            """
            package example;
            ...
            public class Server {
                ...
                private RuntimeWiringConfigurator second() {
                    if (Math.random() < 0) {
                        return wiring();
                    }
                    return b -> b.type(
