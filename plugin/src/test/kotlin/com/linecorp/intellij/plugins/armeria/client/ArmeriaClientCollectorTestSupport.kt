...
object ArmeriaClientCollectorTestSupport {
    @Volatile
    private var registered = false

    fun registerStubs(fixture: JavaCodeInsightTestFixture) {
        if (registered) return
        synchronized(this) {
            if (registered) return
            registerStubsOnce(fixture)
            registered = true
        }
    }

    private fun registerStubsOnce(fixture: JavaCodeInsightTestFixture) {
        fixture.addClass(
            """
