...
class ArmeriaKotlinClientCollectorTest : ArmeriaClientFixtureTestBase() {
    ...
    fun testCollectGrpcClientsCoroutineStubFromKotlinBuilderBuild() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                GrpcClients.builder("https://grpc.example.com").build(FooCoroutineStub::class.java)
            }
            """.trimIndent(),
        )
        myFixture.addClass(
    ...
    fun testCollectGrpcClientsCoroutineStubFromKotlinNewClient() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                GrpcClients.newClient("https://grpc.example.com", FooCoroutineStub::class.java)
            }
            """.trimIndent(),
        )
        myFixture.addClass(
    ...
    fun testCollectHttpPreprocessorEndpointGroupViaProperty() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                val preprocessor = HttpPreprocessor.of(
                    SessionProtocol.HTTP, DnsAddressEndpointGroup.of("example.com", 8080))
                WebClient.of(preprocessor)
            }
            """.trimIndent(),
    ...
    fun testDoesNotLabelNonPreprocessorFactoryAsEndpointGroup() {
        ...
        assertTrue(endpoints.none { it.endpointGroup != null })
    }
}
