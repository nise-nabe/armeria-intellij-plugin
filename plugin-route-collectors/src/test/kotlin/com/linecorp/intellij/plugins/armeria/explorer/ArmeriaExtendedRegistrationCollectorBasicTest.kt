...
class ArmeriaExtendedRegistrationCollectorBasicTest : ArmeriaFixtureTestBase() {
    ...
    fun testCollectsServiceRegistrationWithParenthesizedFluentRouteArgument() {
        myFixture.configureByText(
            "Main.java",
            """
            package example;
    ...
    fun testCollectsServiceFluentRouteArgumentOnceWhenBuildHasHandler() {
        myFixture.configureByText(
            "Main.java",
            """
            package example;
            ...
            public class Main {
                public static void main(String[] args) {
                    ServerBuilder sb = Server.builder();
                    sb.service(sb.route().path("/fluent").build(new HelloService()), new HelloService());
                }
            }
            """.trimIndent(),
        )
    ...
    fun testSkipsServiceRegistrationWithNonArmeriaFluentRouteArgument() {
        myFixture.configureByText(
            "Main.java",
            """
            package example;
            ...
            public class Main {
                public static void main(String[] args) {
                    ServerBuilder sb = Server.builder();
                    OtherBuilder other = new OtherBuilder();
                    sb.service(other.route().post("/other").build(new HelloService()), new HelloService());
                }
            }
            """.trimIndent(),
        )
