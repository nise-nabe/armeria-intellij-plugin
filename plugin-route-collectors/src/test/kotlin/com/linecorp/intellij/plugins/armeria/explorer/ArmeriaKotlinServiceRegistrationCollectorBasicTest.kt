...
class ArmeriaKotlinServiceRegistrationCollectorBasicTest : ArmeriaFixtureTestBase() {
    ...
    fun testCollectGrpcServiceReflectionHintFromKotlin() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
    ...
    fun testCollectKotlinMyProtoReflectionServiceIsNotReflectionBadge() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                Server.builder()
                    .service(
                        "/grpc",
                        GrpcService.builder()
                            .addService(MyProtoReflectionService())
                            .build(),
                    )
                    .build()
            }
    ...
    fun testCollectKotlinFileServiceRootFromFile() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                Server.builder()
                    .service("/files", FileService.of(File("src/main/resources/static")))
                    .build()
            }
            """.trimIndent(),
        )
        ...
        assertEquals("src/main/resources/static", fileRoute.fileServiceRoot?.path)
    }

    fun testCollectKotlinFileServiceRootFromPathsGet() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
    ...
    fun testCollectKotlinFileServiceRootFromBuilder() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                Server.builder()
                    .service("/files", FileService.builder(File("builderRoot")).build())
                    .build()
            }
            """.trimIndent(),
        )
    ...
    fun testCollectKotlinFileServiceRootFromVariable() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                val files = FileService.of(File("variableRoot"))
                Server.builder()
                    .service("/files", files)
                    .build()
            }
    ...
    fun testCollectKotlinFileServiceRootFromClassAnchor() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                Server.builder()
                    .service("/assets", FileService.of(Main::class.java, "/public"))
                    .build()
            }
            """.trimIndent(),
        )
    ...
    fun testCollectKotlinFileServiceRootFromClassLoaderAnchor() {
        myFixture.configureByText(
            "Main.kt",
            """
            package example
            ...
            fun main() {
                Server.builder()
                    .service("/assets", FileService.of(Main::class.java.classLoader, "/static"))
                    .build()
            }
            """.trimIndent(),
        )
