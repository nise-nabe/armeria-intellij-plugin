...
**Cloud Agent self-verification:** after committing implementation (and Gradle compile/tests when
Kotlin/plugin code changed), run `thermo-nuclear-review` self-verification (Phases 1–5) before
the final push that opens or updates the PR. Fix P0–P2 on branch; file or fix every P3; closure
pass is mandatory. See `.cursor/skills/thermo-nuclear-review/SKILL.md` and
