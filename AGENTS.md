...
| `plugin-route-analysis/` | Route Explorer UI helpers, DocService support, navigation, duplicate index, and the public `ArmeriaRouteCollector` façade that wires all contributors together |
