...
internal object ArmeriaKotlinExtendedRegistrationCollectorRouteDecorator {
    ...
    fun addWithRoute(
        ...
        val lambdaBody = (argumentExpression as? KtLambdaExpression
            ...
            ?.bodyExpression
            ?: return
        val buildCall = ArmeriaKotlinExtendedRegistrationCollectorFluentRoute.findFluentRouteBuildForWithRoute(call, lambdaBody)
            ?: return
    ...
    fun extractRouteDecoratorChain(routeDecoratorCall: KtCallExpression): RouteDecoratorChainInfo {
        val outerBuild = ArmeriaKotlinRegistrationChainSupport.findForwardChainedCall(routeDecoratorCall) { call ->
