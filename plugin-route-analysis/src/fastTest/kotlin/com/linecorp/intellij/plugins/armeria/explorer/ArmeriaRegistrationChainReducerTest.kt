...
class ArmeriaRegistrationChainReducerTest {
    ...
    fun reduceFluentRouteChain_stripsFullyQualifiedHttpMethodNames() {
        val chain = ArmeriaRegistrationChainReducer.reduceFluentRouteChain(
            stepsFromBuildUpward = listOf(
                RegistrationChainStep(
                    methodName = "methods",
                    firstStringArg = null,
                    rawMethodArgs = listOf(
    ...
    fun reduceRouteDecoratorChain_stripsFullyQualifiedHttpMethodNames() {
        val chain = ArmeriaRegistrationChainReducer.reduceRouteDecoratorChain(
            steps = listOf(
                RegistrationChainStep(
                    methodName = "methods",
                    firstStringArg = null,
